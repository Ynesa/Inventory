...
titleLabel = tkinter.Label(root, text=storeName, font=('Arial bold', 30), bd=2)
titleLabel.grid(row=0, column=0, columnspan=8, padx=20, pady=20)

idLabel = tkinter.Label(root, text="ID", font=('Arial bold', 15))
nameLabel = tkinter.Label(root, text="Name", font=('Arial bold', 15))
priceLabel = tkinter.Label(root, text="Price", font=('Arial bold', 15))
quantityLabel = tkinter.Label(root, text="Quantity", font=('Arial bold', 15))
...
entryId = tkinter.Entry(root, width=25, bd=5, font=('Arial bold', 15))
entryName = tkinter.Entry(root, width=25, bd=5, font=('Arial bold', 15))
entryPrice = tkinter.Entry(root, width=25, bd=5, font=('Arial bold', 15))
entryQuantity = tkinter.Entry(root, width=25, bd=5, font=('Arial bold', 15))
...
my_tree.column("ID", anchor=tkinter.W, width=100)
my_tree.column("Name", anchor=tkinter.W, width=200)
my_tree.column("Price", anchor=tkinter.W, width=150)
my_tree.column("Quantity", anchor=tkinter.W, width=150)
my_tree.heading("ID", text="ID", anchor=tkinter.W)
my_tree.heading("Name", text="Name", anchor=tkinter.W)
my_tree.heading("Price", text="Price", anchor=tkinter.W)
my_tree.heading("Quantity", text="Quantity", anchor=tkinter.W)
